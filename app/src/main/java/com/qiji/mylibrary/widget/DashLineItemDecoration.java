...
/**
 * RecyclerView的虚线分隔线
 * Created by guoenbo on 2017/9/4.
 */
...
public class DashLineItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param orientation
     */
    public DashLineItemDecoration(int orientation) {
     ...
     * 建议两边边距相同
     */
    public DashLineItemDecoration(int orientation, int leftMargin, int rightMargin) {
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount-1; i++) {
            ...
            PathEffect effects = new DashPathEffect(new float[]{6, 6, 6, 6}, 0);//此处单位是像素不是dp  注意 请自行转化为dp
