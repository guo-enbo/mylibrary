package com.qiji.fingertipfinancial.widget;
...
/**
 * Created by guoenbo on 2017/9/5.
 */
public class NoAnimationBottomNavigationView extends BottomNavigationView {
    // used for animation
    ...
    public NoAnimationBottomNavigationView(Context context) {
        super(context);
//        init();
    }

    public NoAnimationBottomNavigationView(Context context, AttributeSet attrs) {
        super(context, attrs);
//        init();
    }

    public NoAnimationBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * necessary calls back to the provided {@link NoAnimationBottomNavigationView} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<NoAnimationBottomNavigationView> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(NoAnimationBottomNavigationView bnve) {
        ...
        public void onPageSelected(final int position) {
            final NoAnimationBottomNavigationView bnve = mBnveRef.get();
            if (null != bnve)
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, NoAnimationBottomNavigationView bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
